...
int main(int argc, char* argv[])
{
	...
	inputFile2 = fopen("noiseY.bmp", "rb");
	...
	//			for (int n = 0; n < 3; n++)
	//				F += result1[(j - p + m) * pwidth1 + (i - p + n)] * Mean3F[m][n]; // Mean3F
	...
	printf("노이즈 PSNR : %.2lfdB\n", psnr1); // MSE = 683.01(19.79dB)
	...
	printf("복원 PSNR : %.2lfdB\n", psnr2); // MSE = 70.53(29.65dB)
	...
	// 아웃풋이미지 파일1
	FILE* outputFile1 = fopen("student\\22011899.bmp", "wb");
